# m01300_a3 - SHA-224 Hash Accelerator (Streaming Mode)
...
- **Algorithm**: SHA-256 variant with truncated output
...
This configuration leverages 3 cores for optimal streaming throughput with SHA-224.
...
Example: `build_1017_1455/k3/f280000000_c3/m01300_a3.xclbin` (Recommended)
...
```bash
./host build_1017_1455/k3/f280000000_c3/m01300_a3.xclbin 3 616263 1000 0 0
```

**Arguments:**
- `build_1017_1455/k3/f280000000_c3/m01300_a3.xclbin` - Path to xclbin file
...
```bash
./host build_1017_1455/k3/f280000000_c3/m01300_a3.xclbin 3 414243 1000 0 1 Sa1lt123 0
```
...
```bash
./host build_1017_1455/k3/f280000000_c3/m01300_a3.xclbin 3 414243 10000 1 1 Sa1lt123 0 D14A028C2A3A2BC9476102BB288234C415A2B01F828EA62AC5B3E42F
```
...
- `D14A028C...` - Target SHA-224 hash (56 hex characters)
...
- `m01300_a0`: SHA-224 with wordlist input mode
- `m01400_a3`: SHA-256 streaming variant (full 256-bit output)
