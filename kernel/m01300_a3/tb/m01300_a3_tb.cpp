...
int main() {
    ...
    m01300_a3(output_hw, match_index, len, msb_chars, size, mode, golden_dummy, salt, salt_position, use_salt);
    ...
    mode = 1;
    m01300_a3(output_hw, match_index, len, msb_chars, size, mode, golden, salt, salt_position, use_salt);
